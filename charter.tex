...
En la figura \ref{fig:gantt} se muestra el diagrama de gantt del proyecto, el mismo fue obtenido configurando la jornada laboral de 15 horas semanales.

\begin{figure}[htpb]
\centering 
\includegraphics[height=1\textheight]{./Figuras/Gantt-real.png}
